    ...
    <section id="talleres" className="py-24 bg-cream-light">
      <div className="max-w-5xl mx-auto px-6">
        <div className="max-w-2xl mx-auto text-center">
          <p className="text-terracotta italic text-lg mb-8">Alquimia Floral</p>

          <p className="font-arimo text-gray-600 text-base leading-relaxed mb-4">
          ...
          <p className="font-arimo text-gray-600 text-base leading-relaxed">
