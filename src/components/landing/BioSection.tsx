    ...
    <section id="bio" className="py-24 bg-gradient-to-b from-cream to-cream-dark">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="max-w-3xl mx-auto space-y-6 font-arimo text-ink/70 text-base leading-relaxed">
          ...
          <p>
            Esa búsqueda continua me llevó a formarme como Coach Ontológica y Laboral y ser miembro de la International Coaching Federation (ICF). Actualmente me encuentro en proceso de certificación en Mindfulness.
          </p>
