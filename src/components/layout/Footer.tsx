        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-cream/60">
              ...
              <li><a href="mailto:marielabarbettio@gmail.com" className="text-bloom underline hover:text-bloom-deep transition cursor-pointer">✉️ hola@reempoderate.com</a></li>
              <li>🌿 ICF Member</li>
            </ul>
          </div>
        </div>
